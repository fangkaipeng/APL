...
class Trainer:
    ...
    def __init__(self, args):
        ...
        self.model = APL(self.args, self.dict_clss, self.dict_doms, device)
        ...
        # exit(0)
        path_log = os.path.join(args.root_path,'src/alogs/APL/logs', args.dataset, self.save_folder_name, self.suffix)
        self.path_cp = os.path.join(args.root_path, 'src/alogs/APL/saved_models', args.dataset, self.save_folder_name)
    ...
    def training_set(self, stage):
        ...
        lr = self.args.lr
        if stage == 1:
            print("========training specific prompt stage========")
            ...
            lr = lr/2
            print("========training prompt generator stage========")
...
@torch.no_grad()
def evaluate(loader_sketch, loader_image, model:APL, dict_clss, dict_doms, stage, args):
