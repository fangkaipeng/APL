...
class Trainer:
    ...
    def __init__(self, args):
        ...
        # exit(0)
        path_log = os.path.join(args.root_path,'src/alogs/CLIP-Prompted/logs',args.training_strategy, args.dataset, save_folder_name, self.suffix)
        self.path_cp = os.path.join(args.root_path, 'src/alogs/CLIP-Prompted/saved_models',args.training_strategy, args.dataset, save_folder_name)
    ...
    def build_model(self):
        ...
        self.model = CustomCLIP(cfg, classnames, clip_model, device)
...
@torch.no_grad()
def evaluate(loader_sketch, loader_image, model:CustomCLIP, dict_clss, args):
