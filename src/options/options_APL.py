...
class Options:
    ...
    def __init__(self):
        ...
        parser.add_argument('-GP_DOM_NUM_TOKENS', '--GP_DOM_NUM_TOKENS',default=1, type=int, help='initiation for visual prompt')
        parser.add_argument('-GP_CLS_NUM_TOKENS', '--GP_CLS_NUM_TOKENS',default=1, type=int, help='initiation for visual prompt')
        parser.add_argument('-tp_N_CTX', '--tp_N_CTX',default=-1, type=int, help='initiation for visual prompt')
        parser.add_argument('-dropout', '--dropout',default=1.0, type=float, help='use debug model')
