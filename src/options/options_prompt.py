...
class Options:
    ...
    def __init__(self):
        ...
        parser.add_argument('-ts', '--training_strategy',default='VP', type=str, choices=['TP', 'VP', 'TP+VP'], help='training_strategy')
        ...
        # parser.add_argument('-vp_DROPOUT', '--vp_DROPOUT',default=0.5, type=float, help='Dropout of visual prompt')
